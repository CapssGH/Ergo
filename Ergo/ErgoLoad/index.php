...
//coded  by Guillaume.F / OzBal4 https://twitter.com/2guillaumeferon 
...
// color rand box 
include'edit.php';
$colorBox = array($color1,$color2,$color3);
$randcolorBox = array_rand($colorBox, 1);
